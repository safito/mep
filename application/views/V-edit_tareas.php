...
<a href="<?php echo base_url('c_tareas/'); ?>" class="glyphicon glyphicon-arrow-left btn btn-default"> Principal </a>
<br><br><br>


<form action="<?php echo base_url('c_tareas/update') ?>" method="post" class="form-horizontal">
